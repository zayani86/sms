...
$config['tables']['groups']          = 'konf_role';
$config['tables']['profiles']        = 'profile';
$config['tables']['users_groups']    = 'profile_role';
 ...
 */
$config['join']['profiles']  = 'profile_id';
 ...
 */
$config['site_title']                 = "JTS";       // Site Title, example.com
$config['admin_email']                = "freenz@gmail.com"; // Admin Email, admin@example.com
