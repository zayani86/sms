                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="float-right">
                                ...
                                <a href="<?php echo base_url('aktiviti/pentadbiran/pentadbiran_controller/register_activity') . url_akses() ?>" class="btn btn-primary"><i class="icofont icofont-ui-add"></i><?= gettext("Kemasukan Aktiviti") ?></a>
							</div>
