...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#list_table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('aktiviti/aktiviti_kaunseling/aktiviti_controller/dt_senarai_aktiviti') ?><?php echo url_akses() ?>",
                "type": "POST",
                "data": function(data) {
            ...
            "columnDefs": [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (type == "display") {
                            if (data == "1") {
                                return '<div class="bg-success">Aktif</div>';
                            } else {
                                return '<div class="bg-danger">Tidak Aktif</div>';
                            }
                        } else {
                            return data;
                        }
                ...
                },
                {
                    ...
                    render: function(data, type, row){
                        ...
                        let template = "";
                        template += '<a id="btn_edit" href="<?php echo base_url('aktiviti/aktiviti_kaunseling/aktiviti_controller/kemaskini/') ?>' + row[5] + '<?php echo url_akses() ?>" title="Kemaskini"><i class="ti-pencil-alt"></i></a>';
                        return template;
                    }
                }
