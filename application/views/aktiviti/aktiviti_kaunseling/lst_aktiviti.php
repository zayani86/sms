                                ...
                                <div class="col-lg-12">
                                    <form id="search_form" >
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"><?= gettext("Kategori Sesi") ?></label>
                                            <div class="col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="float-right">
                                ...
                                <a href="<?php echo base_url('aktiviti/aktiviti_kaunseling/aktiviti_controller/register_activity') . url_akses() ?>" class="btn btn-primary"><i class="icofont icofont-ui-add"></i><?= gettext("Kemasukan Aktiviti") ?></a>
							</div>
