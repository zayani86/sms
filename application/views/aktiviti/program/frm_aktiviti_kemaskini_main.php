        ...
        <div class="card">
            ...
            <div class="card-block2">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php } else { ?>
                            ...
                            <input type="hidden" name="kategori_id_edit" id="kategori_id_edit" value="<?= $aktiviti->kategori_id ?>" >
                            <input type="hidden" name="id" id="id" value="<?= $aktiviti->id ?>" >
                        <?php } ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="perkara" name="perkara" type="text" class="form-control" rows="4"><?= $aktiviti->perkara ?></textarea>
                    </div>
                </div>
