                    ...
                    <div class="col-sm-12">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="maklumat">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Jenis Sesi<span class="text-danger">&#42;</span></label>
                                    <div class="col-sm-9">
                                        <select name="jenis_sesi" id="test" class="form-control">
                                            <option value="">-- Sila Pilih --</option>
                                            <?= generate_option_konf_kod_by_kategory('INDIVIDU', set_value('jenis_sesi', isset($profile->konf_unit_id) ? $profile->konf_unit_id : "")); ?>
                                        </select>                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Sasaran<span class="text-danger">&#42;</span></label>
                                    <div class="col-sm-9">
                                        <select name="sasaran" id="test" class="form-control">
                                            <option value="">-- Sila Pilih --</option>
