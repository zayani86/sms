...
class MY_Loader extends CI_Loader {
	...
	private $_css = array();
	private $_javascript_footer = array();
	...
	function jsfooter(){
		...
		foreach($script_files as $script_file){
			...
			if(!in_array($script_file, $this->_javascript_footer))
				$this->_javascript_footer[] = $script_file ;
	...
	function get_js_footer_files(){
		return $this->_javascript_footer;
	}
	 ...
	 * @return string
	 */
	function section($area, $views=array(), $data=array()){
