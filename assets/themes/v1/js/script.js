...
//----for ajax csrf regenerate true - start-------//
...
$(document).ready(function () {
    ...
    // $('#csrf_jts_name').val($.cookie('csrf_cookie_name')); 
    $("input[name='csrf_jts_name']").val($.cookie('csrf_cookie_name'));
});
...
//----for ajax csrf regenerate true - end-------//
